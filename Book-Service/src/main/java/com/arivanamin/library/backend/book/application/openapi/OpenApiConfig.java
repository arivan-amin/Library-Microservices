package com.arivanamin.library.backend.book.application.openapi;
...
public class OpenApiConfig {
    ...
    public OpenAPI myOpenAPI () {
        ...
        Info info = new Info().title("Book Service API")
            .description("Provides all the API related to Book service")
            .version("1.0")
