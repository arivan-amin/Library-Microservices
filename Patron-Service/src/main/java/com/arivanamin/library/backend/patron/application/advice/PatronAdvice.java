package com.arivanamin.library.backend.patron.application.advice;
...
class PatronAdvice {
    ...
    ProblemDetail handlePatronNotFound (PatronNotFoundException exception) {
        ProblemDetail detail = forStatusAndDetail(NOT_FOUND, exception.getMessage());
        detail.setTitle("Bad Request, Patron not found");
