package com.arivanamin.library.backend.core.domain.base;
...
public final class CoreApplicationConfig {
    ...
    public static final String APPLICATION_DIRECTORY_NAME = "Library";
    
    public static final String BASE_PACKAGE = "com.arivanamin.library.backend";
