package com.arivanamin.library.backend.patron.application.openapi;
...
public class OpenApiConfig {
    ...
    public OpenAPI myOpenAPI () {
        ...
        Info info = new Info().title("Patron Service API")
            .description("Provides all the API related to Patron service")
            .version("1.0")
