...
import static com.arivanamin.library.backend.core.domain.aspects.ExecuteAndLogPerformance.executeThrowable;
...
public class MeasurePerformanceAspect {
    ...
    @Around ("@annotation(com.arivanamin.library.backend.core.domain.aspects.LogExecutionTime)")
